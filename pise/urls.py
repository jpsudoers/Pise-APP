...
urlpatterns = [
    ...
    path('protocolos/<str:tipo>/upload/', views.ProtocoloUploadView.as_view(), name='protocolo_upload'),
    path('protocolos/<str:tipo>/list/', views.ProtocoloListView.as_view(), name='protocolo_list'),
